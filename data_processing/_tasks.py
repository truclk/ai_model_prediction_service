...
from backend_api.models import FeatureSelectionResult
...
def analyze_dataset_metadata(dataset_upload_id):
    dataset_upload = DatasetUpload.objects.get(id=dataset_upload_id)
    metadata = analyze_metadata(dataset_upload)
    return metadata
...
#     dataset_upload = DatasetUpload.objects.get(id=dataset_upload_id)
#     methods = {"rfe": wrapper_rfe, "chi2": filter_chisquare}
