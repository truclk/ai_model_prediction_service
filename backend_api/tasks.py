...
def process_dataset_upload(dataset_upload_id):
    ...
    for notebook_name in NOTEBOOKS:
        ...
        results = main(notebook_path, training_file_path=path, predict_column=predict_column)
        dataset_upload.datasetresult_set.create(results=results, notebook_name=notebook_name)
